...
def GetUnfoldedSED(pathFileIn):
    """Get values and errors of unfolded SED. Input path of Unfolding_Output_combunfold file.
"""
...
@click.command()
@click.argument('pathinput', type=str)
def main(pathinput):
    GetUnfoldedSED(pathinput)
